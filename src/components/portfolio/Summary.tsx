...
export function Summary() {
  ...
  return (
    <section
      className="py-24 px-4 relative overflow-hidden bg-gradient-to-br from-blue-50/30 via-white to-purple-50/30 dark:from-gray-900/50 dark:via-gray-900 dark:to-gray-800/50"
      ref={ref}
    >
              ...
              >
                ...
                <div className="space-y-6 text-lg leading-relaxed">
                  ...
                  >
                    ...
                    high-performance applications using Node.js, Express.js, and
                    the MERN stack. Experienced in designing RESTful APIs,
                    implementing authentication and authorization, and
                    optimizing server-side performance. Possess a solid
                    foundation in Data Structures & Algorithms, Object-Oriented
                    Programming, DBMS, Operating Systems, and Computer Networks.
                    Skilled in working with databases such as MongoDB and MySQL,
                    along with caching technologies like Redis to enhance
                  ...
                  >
                    Familiar with Git, GitHub, Docker and Postman for
                    streamlined development and deployment. Known for strong
                    problem-solving abilities, clean code practices, and
                    effective collaboration in fast-paced development
                    environments.
                  </motion.p>
                </div>
                ...
                >
                  {[
                    ...
                    <motion.a
                      ...
                      whileTap={{ scale: 0.95 }}
                      className={`px-6 py-3 bg-gradient-to-r ${item.gradient} text-white rounded-full font-semibold shadow-lg hover:shadow-xl transition-all duration-300 flex items-center`}
                    >
                      {item.name}
                      <motion.span
                        animate={{ x: [0, 5, 0] }}
